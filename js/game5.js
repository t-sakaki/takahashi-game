...
function renderG5(){
  ...
  document.getElementById('g5-regime').textContent='現在の制度：'+g5.regime+(g5.regime==='金本位制'?'（金がないと「金」カードが使えない）':'（信用だけで全てのカードが使える）');
...
function g5end(){
  ...
  else{txt='【混乱】三バランスが大きく崩れた。インフレかデフレか、どちらかの危機が深刻化している。最終：需要'+g5.demand+' 供給'+g5.supply+' 物价'+g5.price;}
